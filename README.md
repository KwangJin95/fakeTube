...
* **기간** : 2주
* **인원** : 풀스택 7명
* **소개** : 아이티윌에서 진행한 3차 프로젝트이며, **Spring Web MVC** 및 **JSP**와 **myBatis**를 사용한 개발 및 다양한 타입의 데이터 처리 경험을 목적으로 유튜브 사이트를 모방하여 만든 동영상 플랫폼입니다.
...
<table>
 ...
 - 체크 박스 선택 시 동영상 삭제 기능이 가능하며 선택된 동영상이 없을 경우 다시 사라지며, 동영상 체크 후 삭제하기 클릭 시 삭제 확인 메시지 표시 후 삭제 처리
---
...
└─src
     └─main
         ...
         │                           
         ├─resources
         │   │   applicationContext.xml                        : rootContext 설정 파일
